...
const menuDeSeleccionDeLaGrieta = new SeleccionDePersonaje(iconosDelMenu = [iconoDarius, iconoDrMundo, iconoMaokai])
...
const iconoDarius = new IconosDelMenu( image = "dariusIcono.png", position = game.at(1,5), dialogo = "preciona la tecla A para jugar con Darius" )
